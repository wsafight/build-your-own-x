---
title: 模块打包器 - Minipack
description: 构建你自己的模块打包器 - Minipack
---

原项目为: [minipack](https://github.com/ronami/minipack)，该项目的目的是解释大多数打包器在底层是如何工作的。

在经过很长时间的刀耕火种（开发者需要自行管理脚本依赖和各种优化）。
...
webpack 等打包工具的出现无疑让前端开发者步入下一个时代。
